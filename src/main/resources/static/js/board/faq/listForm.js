...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createSearchUrl() {
        ...
        url.searchParams.set('boardType', 'FAQ'); // 고정된 게시판 타입
    ...
    function renderSearchResults(data, totalElements) {
        ...
        // 공지 사항을 상단으로 정렬
        data.sort((a, b) => b.chkTopFix.localeCompare(a.chkTopFix));
        ...
        data.forEach((item, index) => {
            ...
            <td>
                ${secretLabel}
                ${replyLabel}
                <a href="/masterpage_sys/board/faq/${item.bbsIdx}" class="tit Pretd_SB"> ${titleWithCount} </a>
                ${newLabel}
            </td>
            <!-- 작성일 -->
