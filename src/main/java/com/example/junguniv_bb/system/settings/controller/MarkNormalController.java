...
@Controller
@RequestMapping("/masterpage_sys/mark/normal")
@RequiredArgsConstructor
@Slf4j
public class MarkNormalController {

    /* DI */
    private final SystemCodeService systemCodeService;

    /* 시스템설정 > 기본표시정보 > 일반교육 페이지 */
    @GetMapping
    public String markedNormalForm() {

        return "masterpage_sys/system_code/markNormalForm";
    }
}
